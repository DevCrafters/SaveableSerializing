...
public class SaveableEntry implements SaveableData,SaveableCollection{
    ...
    public void writeBy(StringBuilder builder) {
        ...
        if(type[0] == GenericsResolver.ItemType.Saveable)
            ...
            if(key != null)
                ...
                builder.append(type[0].getNullDefaultObject().toString()).append("\n");
        ...
        if(value != null)
            ...
            builder.append(type[1].getNullDefaultObject().toString()).append("\n");
    ...
    public void appendTo(List<String> builded) {
        ...
        try{
            key = type[0].getResolver().resolve(builded.get(2));
        }catch (Exception ex){}
        try{
            value = type[1].getResolver().resolve(builded.get(3));
        }catch (Exception ex){}
    }
    @Override
